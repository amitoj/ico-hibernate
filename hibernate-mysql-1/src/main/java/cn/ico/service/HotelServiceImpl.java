...
package cn.ico.service;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import cn.ico.domain.City;
import cn.ico.domain.Hotel;
import cn.ico.domain.Rating;
import cn.ico.domain.RatingCount;
import cn.ico.domain.Review;
import cn.ico.domain.ReviewDetails;
